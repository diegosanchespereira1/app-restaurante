export const translations = {
    en: {
        ...
        stockManagementDescription: "Manage product inventory and register purchase invoices",
        inventory: "Inventory",
        stock: "Stock",
        ...
        danfeImport: "Import DANFE",
        importDANFE: "Import DANFE (XML)",
        uploadXML: "Upload XML",
        xmlFile: "XML File",
        parseXML: "Parse XML",
        xmlParsing: "Parsing XML...",
        ...
        addStockEntry: "Add Entry",
        addInventoryItemDescription: "Register a new inventory item without a purchase invoice",
        addStockEntryDescription: "Manually add stock entry for an existing item",
        editInventoryItem: "Edit Item",
        editInventoryItemDescription: "Edit inventory item information",
    ...
    pt: {
        ...
        stockManagementDescription: "Gerencie o estoque de produtos e cadastre notas fiscais de compra",
        inventory: "Estoque",
        stock: "Estoque",
        ...
        newPurchaseInvoice: "Nova Nota Fiscal",
        supplier: "Fornecedor",
        supplierCNPJ: "CNPJ do Fornecedor",
        supplierAddress: "Endereço do Fornecedor",
        invoiceNumber: "Número da Nota",
        invoiceSeries: "Série",
        danfeImport: "Importar DANFE",
        importDANFE: "Importar DANFE (XML)",
        uploadXML: "Enviar XML",
        xmlFile: "Arquivo XML",
        parseXML: "Processar XML",
        xmlParsing: "Processando XML...",
        xmlError: "Erro ao processar XML",
        invalidXML: "XML inválido",
        importSuccess: "Importação realizada com sucesso",
        importFailed: "Falha na importação",
        nfeKey: "Chave de Acesso (NFe)",
        issueDate: "Data de Emissão",
        issuer: "Emitente",
        addInventoryItem: "Adicionar Item",
        addStockEntry: "Adicionar Entrada",
        addInventoryItemDescription: "Cadastre um novo item no estoque sem necessidade de nota fiscal",
        addStockEntryDescription: "Adicione entrada de estoque manualmente para um item existente",
        editInventoryItem: "Editar Item",
        editInventoryItemDescription: "Edite as informações do item de estoque",
        productType: "Tipo de Produto",
        ncm: "NCM",
        cstIcms: "CST ICMS",
        cfop: "CFOP",
        icmsRate: "Alíquota de ICMS",
        ipiRate: "Alíquota de IPI",
        eanCode: "Código de Barras (EAN)",
        taxCalculation: "Cálculo de Impostos",
        priceWithTaxes: "Preço com Impostos",
        basicProductInfo: "Informações Básicas do Produto",
